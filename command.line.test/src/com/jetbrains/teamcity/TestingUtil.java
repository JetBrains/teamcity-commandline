...
public class TestingUtil {
	...
	public static File createFS() throws IOException {
		...
		java_one_file.createNewFile(); FileUtil.writeFileAndReportErrors(java_one_file, "1.java");
		...
		java_two_file.createNewFile(); FileUtil.writeFileAndReportErrors(java_two_file, "2.java");
		...
		java_res_file.createNewFile(); FileUtil.writeFileAndReportErrors(java_res_file, "java.resources");
		...
		cpp_file.createNewFile(); FileUtil.writeFileAndReportErrors(cpp_file, "1.cpp");
		...
		cpp_ress_file.createNewFile(); FileUtil.writeFileAndReportErrors(cpp_ress_file, "1.cpp.resources");
