...
> This plugin is **no longer supported**. Use REST API to [upload plugins directly](https://www.jetbrains.com/help/teamcity/personal-build.html#Direct+Patch+Upload) instead.
> 
{type="note"}
